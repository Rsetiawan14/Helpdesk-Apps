...
<div class="wrapper">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <a href="#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="{{asset('adminlte/img/user4-128x128.jpg')}}" alt="User Avatar" class="img-size-50 img-circle mr-3">
              <div class="media-body">
                <h3 class="dropdown-item-title">
                  John Pierce
  ...
  <aside class="main-sidebar sidebar-dark-maroon elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="{{asset('adminlte/img/AdminLTELogo.png')}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">Resque</span>
    </a>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <li class="nav-item">
              <a href="/helpdeskreq" class="nav-link active">
          ...
          <li class="nav-item">
            <a href="/settuser" class="nav-link">
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2020 <a href="">IT Team Nusindo</a></strong>
    All rights reserved.
