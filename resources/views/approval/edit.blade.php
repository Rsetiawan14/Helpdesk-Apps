            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <form action="/approval/{{$mstreport->id}}/update" method="POST">
                        {{csrf_field()}}
                        <!-- radio -->
                      <div class="row">
                        <div class="form-group clearfix">
                            <div class="icheck-success d-inline">
                              <input type="radio" name="status" id="radioSuccess1" value="1">
                              <label for="radioSuccess1">Setuju
                              </label>
                            </div>
                            <div class="icheck-danger d-inline">
                              <input type="radio" name="status" id="radioSuccess2" value="0">
